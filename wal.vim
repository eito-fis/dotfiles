...
exe 'hi IndentBlanklineChar guibg=NONE ctermbg=NONE ctermfg=1 guifg=#111921'
exe 'hi IndentBlanklineContextChar guibg=NONE ctermbg=NONE ctermfg=3 guifg='.g:color3
exe 'hi NvimTreeFolderIcon guibg=NONE ctermbg=NONE ctermfg=15 guifg='.g:color12
exe 'hi CocErrorSign guibg='.g:color0.' ctermbg=0 ctermfg=4 guifg='.g:color4
exe 'hi CocInfoSign guibg='.g:color0.' ctermbg=0 ctermfg=1 guifg='.g:color1
exe 'hi CocWarningSign guibg='.g:color0.' ctermbg=0 ctermfg=5 guifg='.g:color5
exe 'hi CocHintSign guibg='.g:color0.' ctermbg=0 ctermfg=1 guifg='.g:color1
exe 'hi CocUnderline guibg='.g:color0.' ctermbg=0 ctermfg=1 guifg='.g:color1
exe 'hi CocFadeOut cterm=underline gui=underline guibg=None ctermbg=None ctermfg=1 guifg='.g:color1
exe 'hi CocMarkdownLink guibg=NONE ctermbg=NONE ctermfg=5 guifg='.g:color5
exe 'hi NormalFloat guibg='.g:color0.' ctermbg=0 ctermfg=7 guifg='.g:color7
exe 'hi TelescopeSelection cterm=bold gui=bold ctermbg=0 guibg='.g:color0.' ctermfg=15 guifg='.g:color15 
